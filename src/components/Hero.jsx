...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      {/* Gradient Overlay for text & navbar readability */}
      <div className="absolute inset-0 z-10 bg-gradient-to-r from-black/30 via-black/10 to-transparent pointer-events-none" />
      <div className="absolute top-0 left-0 w-full h-28 z-10 bg-gradient-to-b from-black/35 to-transparent pointer-events-none" />
